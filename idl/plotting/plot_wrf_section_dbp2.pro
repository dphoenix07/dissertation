PRO PLOT_WRF_SECTION_DBP2, experiment, state, x0, y0, x1, y1, date, $
	DOMAIN       = domain, $
	MAP_TYPE     = map_type, $
...
;		 table = [HCL_COLOR_TABLE(6 , HUE_RANGE = [220.0,220.0], SAT_RANGE = [0.2,1.0], /REV), $
;          		  HCL_COLOR_TABLE(24, HUE_RANGE = [  0.0,  0.0], SAT_RANGE = [0.2,1.0])]
...
;		 fill_sect_levels = MAKEN(-0.010, 0.020, 30)
