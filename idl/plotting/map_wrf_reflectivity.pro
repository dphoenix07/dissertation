...
outdir  = !WRF_DIRECTORY + run + '/paper/plots/wrf_refl_5km/'
...
;MAP_SET, yc, xc, 0, CONIC = 1, STANDARD_PARALLELS=[0,1], /NOBORDER, $																;Draw map
...
;	CONTOUR, MAX(R.values, DIM=3), x.values, y.values, $												;Contour reflectivity values
	CONTOUR, refl_5km, x.values, y.values, $													;For T-Matrix comparison
		OVERPLOT  = 1, $
		FILL      = 1, $
		LEVELS    = rlevels, $
		C_COLOR   = table
...
MAP_CONTINENTS, /USA, /CONTINENTS, /HIRES, COLOR = COLOR_24('black'), THICK = 2*!P.THICK
...
MAP_SET, yc, xc, 0, CONIC = 1, /NOBORDER, $																				;Redraw map boundaries
	LIMIT     = [y0,x0,y1,x1,y2,x2,y3,x3], $
	ISOTROPIC = 1, $
	NOERASE   = 1, $
	POSITION  = map_pos
