PRO PLOT_MULTI_SCATTER_EFFICIENT, event, scheme, start_date, end_date, $
	DOMAIN   = domain, $
	IN_CLOUD = in_cloud, $
	BINNED   = binned, $
	REGION   = region, $
...
; Calling sequence:
;		PLOT_MULTI_SCATTER_EFFICIENT, run, scheme, start_date, end_date
; Input:
...
WRF_TRACER_RALT, 1.0E3*o3_arr, 0.001*(z_arr-xyz_troparr), refl_arr, cloud_arr, $									;Call WRF_TRACER_RALT to produce scatterplots
	TITLE     = title, $
	XRANGE    = [0, 400], $
	XTITLE    = 'Ozone (ppbv)', $
	YTITLE    = ytitle, $
...
WRF_TRACER_RALT, 1.0E3*hno3_arr, 0.001*(z_arr-xyz_troparr), refl_arr, cloud_arr, $
	TITLE     = title, $
	XRANGE    = [0, 3], $
...
WRF_TRACER_RALT, 1.0E3*hcho_arr, 0.001*(z_arr-xyz_troparr), refl_arr, cloud_arr, $
	TITLE     = title, $
	XRANGE    = [0, 3], $
	XTICKS    = 3, $
	XMINOR    = 4, $
