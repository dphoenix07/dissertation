PRO PLOT_WRF_TRACER_RALT, date, event, scheme, $
	DOMAIN		= domain, $
	BINNED      = binned, $
	FILTERING   = filtering, $
	THRESHOLD   = threshold, $
...
var = var[good]
WRF_TRACER_RALT, 1.0E3*var, 0.001*(z-xyz_trop), refl, cloud, $
	TITLE     = title, $
	XRANGE    = [0, 400], $
	XTITLE    = 'Ozone (ppbv)', $
	YTITLE    = ytitle, $
...
var = var[good]
WRF_TRACER_RALT, 1.0E6*var, 0.001*(z-xyz_trop), refl, cloud, $
	TITLE     = title, $
	XRANGE    = [1, 500], $
...
var += (WRF_READ_VAR('NO', date, event, scheme, DOMAIN = domain)).values									;Read nitrogen oxide data
