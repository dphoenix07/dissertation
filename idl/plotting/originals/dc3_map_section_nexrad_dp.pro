...
FOR i = 0, nplot -1 DO BEGIN
	...
	IF (i EQ 0) THEN BEGIN
		data1 = NEXRAD_READ_LEVEL2_2(rfile[it0[i]])											;Read radar data
		data2 = NEXRAD_READ_LEVEL2_2(rfile[it0[i]+1])
	...
	ENDIF ELSE IF (it0[i] NE itlast) THEN BEGIN
		...
		data2 = NEXRAD_READ_LEVEL2_2(rfile[it0[i]+1])										;Read radar data
