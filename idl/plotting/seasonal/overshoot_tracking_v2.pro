PRO OVERSHOOT_TRACKING_V2, event, scheme, start_date, end_date, $
	DOMAIN   = domain, $
	REGION   = region, $
	RAD	     = rad, $
	TROP_REL = trop_rel, $
...
; Calling sequence:
;		OVERSHOOT_TRACKING_V2, run, scheme, start_date, end_date
; Input:
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	FOR i = 0, ov_count-1 DO BEGIN
		...
		;Updated 02/07/2019: Make zone between tropopause and +4km trop. rel.
		cyl_bottom = ztrop1[over[i]]    
		cyl_top =  cyl_bottom + 4000.0
...
ENDIF  ;; map plot
	...
	outdir  = !WRF_DIRECTORY + event + '/' + scheme + '/reduced/overshoot_statistics_v2/'
