PRO WRITE_O3_TIMESERIES_FILE_V2, run, experiment, start_date, end_date, $
	DOMAIN        = domain, $
	REGION        = region, $
...
FOREACH date, date_arr DO BEGIN
	...
	o3    = (WRF_READ_VAR('O3_tracer'			   , date, run, experiment, DOMAIN = domain, INDICES = region)).values 
	...
	FOR ii = 5, dim[0]-5 DO BEGIN
		FOR jj = 5, dim[1]-5 DO BEGIN
			...
			IF (ii EQ 	     5) THEN BEGIN
				;flux_u_left[*,jj,*]   = u[ii,jj,(index0-10):(index0)]*o3_kg[ii,jj,(index0-10):(index0)]
				nanl    = WHERE((u[ii,jj,(index0-10):(index0)]*o3_kg[ ii,jj,(index0-10):(index0)]) NE 0.0, left_count0)
				nanairl = WHERE((u[ii,jj,(index0-10):(index0)]*air_kg[ii,jj,(index0-10):(index0)]) NE 0.0, airleft_count0)
				flux_u_left_ave    [*,jj] = TOTAL(u[ii,jj,(index0-10):(index0)]*o3_kg [ii,jj,(index0-10):(index0)],/NAN) / left_count0
				flux_u_left_tot    [*,jj] = TOTAL(u[ii,jj,(index0-10):(index0)]*o3_kg [ii,jj,(index0-10):(index0)],/NAN) 
				flux_air_left_ave  [*,jj] = TOTAL(u[ii,jj,(index0-10):(index0)]*air_kg[ii,jj,(index0-10):(index0)],/NAN) / airleft_count0
				flux_air_left_tot  [*,jj] = TOTAL(u[ii,jj,(index0-10):(index0)]*air_kg[ii,jj,(index0-10):(index0)],/NAN) 
			ENDIF
			IF (ii EQ dim[0]-5) THEN BEGIN
				;flux_u_right[*,jj,*]  = u[ii,jj,(index0-10):(index0)]*o3_kg[ii,jj,(index0-10):(index0)]
				nanr    = WHERE((u[ii,jj,(index0-10):(index0)]*o3_kg [ii,jj,(index0-10):(index0)]) NE 0.0, right_count0)
				nanairr = WHERE((u[ii,jj,(index0-10):(index0)]*air_kg[ii,jj,(index0-10):(index0)]) NE 0.0, airright_count0)
				flux_u_right_ave   [*,jj] = TOTAL(u[ii,jj,(index0-10):(index0)]*o3_kg [ii,jj,(index0-10):(index0)],/NAN) / right_count0
				flux_u_right_tot   [*,jj] = TOTAL(u[ii,jj,(index0-10):(index0)]*o3_kg [ii,jj,(index0-10):(index0)],/NAN) 
				flux_air_right_ave [*,jj] = TOTAL(u[ii,jj,(index0-10):(index0)]*air_kg[ii,jj,(index0-10):(index0)],/NAN) / airright_count0
				flux_air_right_tot [*,jj] = TOTAL(u[ii,jj,(index0-10):(index0)]*air_kg[ii,jj,(index0-10):(index0)],/NAN) 
			ENDIF
			IF (jj EQ 	     5) THEN BEGIN
				;flux_v_bottom[ii,*,*] = v[ii,jj,(index0-10):(index0)]*o3_kg[ii,jj,(index0-10):(index0)]
				nanb 	= WHERE((v[ii,jj,(index0-10):(index0)]*o3_kg [ii,jj,(index0-10):(index0)]) NE 0.0, bottom_count0)
				nanairb = WHERE((v[ii,jj,(index0-10):(index0)]*air_kg[ii,jj,(index0-10):(index0)]) NE 0.0, airbottom_count0)
				flux_v_bottom_ave  [ii,*] = TOTAL(v[ii,jj,(index0-10):(index0)]*o3_kg [ii,jj,(index0-10):(index0)],/NAN) / bottom_count0
				flux_v_bottom_tot  [ii,*] = TOTAL(v[ii,jj,(index0-10):(index0)]*o3_kg [ii,jj,(index0-10):(index0)],/NAN) 
				flux_air_bottom_ave[ii,*] = TOTAL(v[ii,jj,(index0-10):(index0)]*air_kg[ii,jj,(index0-10):(index0)],/NAN) / airbottom_count0
				flux_air_bottom_tot[ii,*] = TOTAL(v[ii,jj,(index0-10):(index0)]*air_kg[ii,jj,(index0-10):(index0)],/NAN) 
			ENDIF
			IF (jj EQ dim[1]-5) THEN BEGIN
				;flux_v_top[ii,*,*]    = v[ii,jj,(index0-10):(index0)]*o3_kg[ii,jj,(index0-10):(index0)]
				nant 	= WHERE((v[ii,jj,(index0-10):(index0)]*o3_kg [ii,jj,(index0-10):(index0)]) NE 0.0, top_count0)
				nanairt = WHERE((v[ii,jj,(index0-10):(index0)]*air_kg[ii,jj,(index0-10):(index0)]) NE 0.0, airtop_count0)
				flux_v_top_ave   [ii,*] = TOTAL(v[ii,jj,(index0-10):(index0)]*o3_kg [ii,jj,(index0-10):(index0)],/NAN) / top_count0
				flux_v_top_tot   [ii,*] = TOTAL(v[ii,jj,(index0-10):(index0)]*o3_kg [ii,jj,(index0-10):(index0)],/NAN) 
				flux_air_top_ave [ii,*] = TOTAL(v[ii,jj,(index0-10):(index0)]*air_kg[ii,jj,(index0-10):(index0)],/NAN) / airtop_count0
				flux_air_top_tot [ii,*] = TOTAL(v[ii,jj,(index0-10):(index0)]*air_kg[ii,jj,(index0-10):(index0)],/NAN) 
			ENDIF
			
			o3_kg_2d    [ii,jj] = TOTAL(o3_kg   [ii,jj,(index0-10):(index0)])
			air_kg_2d   [ii,jj] = TOTAL(air_kg[ii,jj,(index0-10):(index0)])
			...
			iairnan  = WHERE(FINITE(air_nan     [ii,jj,(index0-10):(index0)],/NAN),nan_count, COMPLEMENT = ivalue, NCOMPLEMENT = airvalue_count1)
...
IF (run EQ '20120530_ncar') THEN BEGIN 
    PLOT, SHIFT((do3_dt/dair_dt),1), $
    	YRANGE 	 = [-4E-8,4E-8], $
    	YTITLE   = 'o3 (kg/s)', $
    	COLOR    = COLOR_24('black'), $
