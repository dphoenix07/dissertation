PRO WRITE_H2O_THETA_TIMESERIES_FILE_V2, run, experiment, start_date, end_date, $
	DOMAIN        = domain, $
	REGION        = region, $
...
;+
; Name:
;		WRITE_h2o_THETA_TIMESERIES_FILE_V2
; Purpose:
;		Calculates % mass (kg) of h2o in some layer
; Calling sequence:
;		WRITE_h2o_THETA_TIMESERIES_FILE_V2, run, scheme, start_date, end_date
;		WRITE_h2o_THETA_TIMESERIES_FILE_V2, '20120530_ncar','d03_30km','20120530T2200Z','20120531T0500Z'
; Input:
...
; Author and history:
;		Daniel B. Phoenix	    2019-08-27. Differs from v1 in that the % h2o mass is 
;											plotted
;	 
;-
...
outdir  = !WRF_DIRECTORY + run + '/' + experiment + '/plots/h2o_timeseries_theta_v2/'
...
fname = outdir+run+'_perch2o_theta.txt'
