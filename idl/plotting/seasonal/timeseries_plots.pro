PRO TIMESERIES_PLOTS, event, scheme, start_date, end_date, $
	DOMAIN   = domain, $
	REGION   = region, $
	TROP_REL = trop_rel, $
	REFL	 = refl, $
...
; Calling sequence:
;		TIMESERIES_PLOTS, run, scheme, start_date, end_date
; Input:
...
outdir  = !WRF_DIRECTORY + event + '/' + scheme + '/plots/timeseries/'
FILE_MKDIR, outdir
