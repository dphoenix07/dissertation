PRO CONVECTIVE_INFLUENCE_TEMPERATURE, event, start_date, end_date, $
	DOMAIN      = domain, $
...
;+
; Name:
;		CONVECTIVE_INFLUENCE_TEMPERATURE
; Purpose:
;		Computes min/median/max profile of temperature and compares those profiles with
;		convective influence (using updraft and cloud-at-trop tracers) to those without.
; Calling sequence:
;		CONVECTIVE_INFLUENCE_TEMPERATURE, run, scheme, start_date, end_date
; Example: CONVECTIVE_INFLUENCE_TEMPERATURE,'20120519','20120520T0000Z','20120520T0300Z'
; Input:
...
FOR c = 0, 1 DO BEGIN
     ...
     FOREACH var, var_arr DO BEGIN 
        ...
        tracer_obs = (WRF_READ_VAR('T', date_arr[0], event, scheme, DOMAIN = domain, INDICES = region)).values					;Read ozone values
