PRO MAP_OZONE_ISENTROPE2, event, scheme, start_date, end_date, $
	DOMAIN   = domain, $
	REGION   = region, $
	TRACER   = tracer, $
	THRES	 = thres, $
...
outdir  = !WRF_DIRECTORY + event + '/' + scheme + '/plots/ozone_wrapping/'
FILE_MKDIR, outdir
...
ENDIF ELSE $	
	...
	ENDIF
	 ...
	 map_plot1      = 0.001*((MAX((cloud.values GE 5.0E-4)*z, DIM = 3, /NAN)) - xyz_trop)																;Set map variable to cloud top altitude
