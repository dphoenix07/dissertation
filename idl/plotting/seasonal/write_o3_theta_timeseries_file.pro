PRO WRITE_O3_THETA_TIMESERIES_FILE, run, experiment, start_date, end_date, $
	DOMAIN        = domain, $
	REGION        = region, $
...
;+
; Name:
;		WRITE_O3_THETA_TIMESERIES_FILE
; Purpose:
;		Calculates mass (kg) of O3 in some layer
; Calling sequence:
;		WRITE_O3_THETA_TIMESERIES_FILE, run, scheme, start_date, end_date
;		WRITE_O3_THETA_TIMESERIES_FILE, '20120530_ncar','d03_30km','20120530T2200Z','20120531T0500Z'
; Input:
...
outdir  = !WRF_DIRECTORY + run + '/' + experiment + '/plots/o3_timeseries_theta/'
