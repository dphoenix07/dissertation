...
;IF (N_ELEMENTS(infile   ) EQ 0) THEN infile    = '/data3/WRF/Mallory/control.nc'
;IF (N_ELEMENTS(directory) EQ 0) THEN directory = '/data1/winds/'						;Default output directory for wind file
...
;dt		  = 3*3600											;Time interval in s (1 hour)
dt              = 3600 

;date1   = MAKE_DATE(2011, 4, 12, 03)
;date2   = MAKE_DATE(2011, 4, 13, 12)
...
;print, MAX(uwrf0[*,*,28],/NAN), MAX(vwrf0[*,*,28],/NAN),zwrf[400,200,20:25]
;42.7870      35.9082      3662.54~4752.12
