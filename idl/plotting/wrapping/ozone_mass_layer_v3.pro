PRO OZONE_MASS_LAYER_V3, run, experiment, start_date, end_date, $
	DOMAIN        = domain, $
	REGION        = region, $
...
; Calling sequence:
;		OZONE_MASS_LAYER_V3, run, scheme, start_date, end_date
;		OZONE_MASS_LAYER_V3, '20120530_ncar','d03_30km','20120530T2200Z','20120531T0500Z'
; Input:
...
FOREACH date, date_arr DO BEGIN
	...
	FOR k = 0, dim[2]-1 DO BEGIN
		...
		flux_u_tot  [k] = (TOTAL((u[5,*,k]*ozone_kg[5,*,k] - u[dim[0]-5,*,k]*ozone_kg[dim[0]-5,*,k]),/NAN)) / ((dim[0] - 11) * dx)
		flux_v_tot  [k] = (TOTAL((v[*,5,k]*ozone_kg[*,5,k] - v[*,dim[1]-5,k]*ozone_kg[*,dim[1]-5,k]),/NAN)) / ((dim[1] - 11) * dx)
