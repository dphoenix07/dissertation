PRO PBL_VERT_PROFILE, event, start_date, $
		AIR_POL    = air_pol, $
		scheme     = scheme, $
		DOMAIN 	   = domain, $
		REGION 	   = region, $
...
ENDFOR
	...
	OPLOT, var_mean1, z_mean1, LINESTYLE=0
	OPLOT, var_mean2, z_mean1, LINESTYLE=1
	OPLOT, var_mean3, z_mean1, LINESTYLE=2
	...
	PLOT, var_mean, z_mean, /NODATA, $
			TITLE	  = STRMID(MAKE_ISO_DATE_STRING(TIME_INC(start_date,1*1800)),11,8) + " UTC", $
			XTITLE    = xtitle, $
			NOERASE   = 1, $
			XRANGE    = xrange, $
			CHARSIZE  = 3, $
	...
	OPLOT, var_mean4, z_mean2, LINESTYLE=0
	OPLOT, var_mean5, z_mean2, LINESTYLE=1
	OPLOT, var_mean6, z_mean2, LINESTYLE=2
	...
	OPLOT, var_mean7, z_mean3, LINESTYLE=0
	OPLOT, var_mean8, z_mean3, LINESTYLE=1
	OPLOT, var_mean9, z_mean3, LINESTYLE=2
