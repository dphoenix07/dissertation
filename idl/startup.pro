...
;DEFSYSV, '!WRF_DIRECTORY'   , '/data3/rpmanser/'
...
DEFSYSV, '!JRA55_DIRECTORY', '/data1/JRA-55/'
DEFSYSV, '!JRA55_GRB',       '/data1/JRA-55/grib/'
DEFSYSV, '!JRA55_NCD',       '/data1/JRA-55/netcdf/'

;MERRA2 Reanalysis data
DEFSYSV, '!MERRA2_DIRECTORY',     '/data3/MERRA2/'
DEFSYSV, '!MERRA2_MODEL',         '/data3/MERRA2/model/'
DEFSYSV, '!MERRA2_MODEL_REDUCED', '/data3/MERRA2/model_reduced/'
DEFSYSV, '!MERRA2_NCD',           '/data3/MERRA2/netcdf/'

;ERA-Interim Reanalysis data
DEFSYSV, '!ERA_INTERIM_DIRECTORY',     '/data1/ERA-Interim/'
DEFSYSV, '!ERA_INTERIM_GRB',           '/data1/ERA-Interim/grib/'
DEFSYSV, '!ERA_INTERIM_NCD',           '/data1/ERA-Interim/netcdf/'

;Newline
DEFSYSV, '!NEW_LINE', STRING(10B)

WINDOW
!P.BACKGROUND = COLOR_24('white')                                                                                                                                               ;Set background color
!P.COLOR      = COLOR_24('black')                                                                                                                                               ;Set foreground color0
ERASE
WDELETE
