...
id=ncdf_open('/glade/p/work/barthm/run.0529.v36.15km/wrfinput_'+domain)
...
output_path = '/glade/p/work/barthm/WRFemis_NEI2011/PREPEMIS/'
...
; 1 short ton = 907.185 kg = 907185 g = 9.07185 ug
        ...
        if ispec lt 3 then print, 'areadata/4  ', max(areadata)
...
; idl index starts at 0, grid index at 1!!!
        ...
        if ispec lt 3 then print, 'wrfemis  ', max(wrfemis[ispec,*,*,*])
...
; average:
        ...
        if ispec lt 3 then print, 'avg wrfemis  ', max(wrfemis[ispec,*,*,*])
...
; VOCs   
    ; derive emissions for C2H5OH by scaling to CO
    ; scaling factor calculated from POET: /ur/pfister/INTEXB/emissions_new/C2H5OHvsCO.pro
    ; ncdf_varput,ncid,'E_C2H5OH',reform(wrfemis[0,*,*,*])*0.003960
...
; C3H8 = propane
     ncdf_varput,ncid,'E_C3H8',reform(wrfemis[48,*,*,*]+wrfemis[40,*,*,*]) 

; CH2O = formaldehyde
     ncdf_varput,ncid,'E_CH2O',reform(wrfemis[17,*,*,*]) 

; CH3CHO = acetaldehyde
     ncdf_varput,ncid,'E_CH3CHO',reform(wrfemis[18,*,*,*]+wrfemis[27,*,*,*])
...
; MEK=  methyl-ethyle-ketone
     ncdf_varput,ncid,'E_MEK',reform(wrfemis[22,*,*,*])

; TOLUENE
     ncdf_varput,ncid,'E_TOLUENE',reform(wrfemis[15,*,*,*]+wrfemis[16,*,*,*]+wrfemis[20,*,*,*]+wrfemis[41,*,*,*] +$
                                         wrfemis[44,*,*,*]+wrfemis[45,*,*,*]+wrfemis[46,*,*,*]+wrfemis[47,*,*,*] +$
                                         wrfemis[25,*,*,*]+wrfemis[26,*,*,*]+wrfemis[28,*,*,*]+wrfemis[29,*,*,*])

; ISOP
     ncdf_varput,ncid,'E_ISOP',reform(wrfemis[13,*,*,*]+wrfemis[30,*,*,*]+wrfemis[31,*,*,*]+wrfemis[32,*,*,*])
