...
;input wrfinput file 
domain = 'd01'
wrfinput_file  = '/glade/scratch/phoenix2/august_simulation_final/nest/wrfinput_'+domain
;input emission data directory

area_emis_dir   = '/glade/scratch/phoenix2/wrfchemi/'
point_emis_dir  = '/glade/scratch/phoenix2/wrfchemi/'
ipoint = 224097L 
...
output_dir = '/glade/scratch/phoenix2/wrfchemi/'
...
specnames = ['CO','NOX','SO2','NH3', $
                'HC02', 'HC03', 'HC04', 'HC05', $       ; see readme text for mapping of VOCs
...
;    PMFINE (54)
        ...
        endif else if ispec gt 3 and ispec le 41 then begin
            print, 'area  VOC: ', specnames[ispec]
            fac = 1.;/(dx*dx)
        endif else if ispec ge 42 then begin
...
; VOC Speciation   
; Ethane
    ncdf_varput,ncid,'E_ETH',reform(wrfemis[4,*,*,*])  
 
 ; Alkane 500<kOH<5000 exclude (C3H8, C2H2, organic acides, butanes), Acetylene, Butanes, Propane   
    tmp = wrfemis[5,*,*,*]+wrfemis[6,*,*,*]+wrfemis[22,*,*,*]+wrfemis[32,*,*,*]+wrfemis[34,*,*,*]+wrfemis[38,*,*,*]
    ncdf_varput,ncid,'E_HC3',reform(tmp) 

; Alkane 5000<kOH<10000 exclude (pentanes), Pentanes
	ncdf_varput,ncid,'E_HC5',reform(wrfemis[7,*,*,*]+wrfemis[35,*,*,*])

; Alkane 10000>kOH 
	ncdf_varput,ncid,'E_HC8',reform(wrfemis[8,*,*,*])

; Ethylene
	ncdf_varput,ncid,'E_OL2',reform(wrfemis[9,*,*,*])
	
; Alkene kOH <20000 /ppm/min, methacrolein, methylvinyl ketone, propylene, styrenes
	tmp = wrfemis[10,*,*,*]+(wrfemis[28,*,*,*]*0.5)+(wrfemis[29,*,*,*]*0.5)+wrfemis[31,*,*,*]+wrfemis[40,*,*,*]
	ncdf_varput,ncid,'E_OLT',reform(tmp)

; Alkene kOH >20000 /ppm/min, Dienes
	ncdf_varput,ncid,'E_OLI',reform(wrfemis[11,*,*,*]+wrfemis[41,*,*,*])

; Isoprene
	ncdf_varput,ncid,'E_ISO',reform(wrfemis[12,*,*,*])

; Aromatic kOH < 20000 /ppm/min exclude(benzene and toluene), Benzene, Toluene, Styrenes
	tmp = wrfemis[13,*,*,*]+wrfemis[33,*,*,*]+wrfemis[36,*,*,*]+wrfemis[40,*,*,*]
	ncdf_varput,ncid,'E_TOL',reform(tmp)

; Aromatic kOH > 20000 /ppm/min exclude(xylenes), Xylenes
	tmp = wrfemis[14,*,*,*]+wrfemis[37,*,*,*]
	ncdf_varput,ncid,'E_XYL',reform(tmp)

; Formaldehyde
	ncdf_varput,ncid,'E_HCHO',reform(wrfemis[15,*,*,*])

; Acetaldehyde,higher aldehydes,benzaldehyde,glyoxal,methylglyoxal,biacetyl,methacrolein
	tmp = wrfemis[16,*,*,*]+wrfemis[17,*,*,*]+wrfemis[18,*,*,*]+wrfemis[23,*,*,*] $ 
			+wrfemis[24,*,*,*]+wrfemis[25,*,*,*]+(wrfemis[28,*,*,*]*0.5)
	ncdf_varput,ncid,'E_ALD',reform(tmp)
	
;Acetone, methylethyl ketone, PRD2 SAPRAC species (ketone), methylvinyl ketone
	tmp = wrfemis[19,*,*,*]+wrfemis[20,*,*,*]+wrfemis[21,*,*,*]+(wrfemis[29,*,*,*]*0.5)+wrfemis[30,*,*,*]
	ncdf_varput,ncid,'E_KET',reform(tmp)

; Phenols, cresols
	tmp = wrfemis[26,*,*,*]+wrfemis[27,*,*,*]
	ncdf_varput,ncid,'E_CSL',reform(tmp)

; Organic acides
	ncdf_varput,ncid,'E_ORA2',reform(wrfemis[41,*,*,*])

; Unspeciated primary PM2.5 - nuclei mode
	ncdf_varput,ncid,'E_PM25I',reform(wrfemis[42,*,*,*]*0.20)

; Unspeciated primary PM2.5 - accumulation mode
	ncdf_varput,ncid,'E_PM25J',reform(wrfemis[42,*,*,*]*0.80)

; Sulfate PM2.5 - nuclei mode
	ncdf_varput,ncid,'E_SO4I',reform(wrfemis[43,*,*,*]*0.20)
	
; Sulfate PM2.5 - accumulation mode
	ncdf_varput,ncid,'E_SO4J',reform(wrfemis[43,*,*,*]*0.80)

; Nitrate PM2.5 - nuclei mode
	ncdf_varput,ncid,'E_NO3I',reform(wrfemis[44,*,*,*]*0.20)

; Nitrate PM2.5 - accumulation mode
	ncdf_varput,ncid,'E_NO3J',reform(wrfemis[44,*,*,*]*0.80)

; Organic PM2.5 - nuclei mode
	ncdf_varput,ncid,'E_ORGI',reform(wrfemis[45,*,*,*]*0.20)

; Organic PM2.5 - accumulation mode
	ncdf_varput,ncid,'E_ORGJ',reform(wrfemis[45,*,*,*]*0.80)

; Elemental Carbon PM2.5 - nuclei mode
	ncdf_varput,ncid,'E_ECI',reform(wrfemis[46,*,*,*]*0.20)

; Elemental Carbon PM2.5 - accumulation mode
	ncdf_varput,ncid,'E_ECJ',reform(wrfemis[46,*,*,*]*0.80)

; Unspeciated Primary PM10
	ncdf_varput,ncid,'E_PM_10',reform(wrfemis[47,*,*,*])
