...
id=ncdf_open('/glade/scratch/cuchiara/Vsimulation/wrfinput_'+domain)
...
nei_path = '/glade/p/acd/alma/WRF_emisrgd/WRFemis_NEI2011/'
;output_path = '/glade/p/work/barthm/WRFemis_NEI2011/DC3/'
output_path = '/glade/scratch/cuchiara/Vsimulation/'
