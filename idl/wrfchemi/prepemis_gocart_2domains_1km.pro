...
;id=ncdf_open('/glade/p/work/barthm/run.20120529.v35.wetscav/wrfinput_'+domain)
id=ncdf_open('/glade/p/work/megan/WRFV3.5.1-Chem/run/wrfinput_'+domain)
print, '/glade/p/work/megan/WRFV3.5.1-Chem/run/wrfinput_'+domain
...
output_path = '/glade/scratch/barthm/DC3_emissions_1km/'
