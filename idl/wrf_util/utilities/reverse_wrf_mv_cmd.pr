PRO REVERSE_WRF_MV_CMD, date1, date2, $
	DT     = dt, $
	DOM    = dom, $
	OUTDOM = dom2
...
;		names for archiving. 
; Calling sequence:
;		REVERSE_WRF_MV_CMD, MAKE_DATE(2014,5,1,12), MAKE_DATE(2014,5,3,0)
; Input:
...
;		Daniel B. Phoenix	2017-05-10.		reversed original
;-
...
WHILE (TIME_DIFF(date, date2) LE 0) DO BEGIN
	...
	PRINT, 'mv wrfout_' + dom2 + '_' + dates + '.nc wrfout_' + dom + '_' + yyyy + '-' + mm + '-' + dd_hh + $						
			 '\:' + min + '\:00'
