PRO REMAKE_WRF_NC_CHEM, run, scheme, $
	TRACER     = tracer, $
	DBP_TR     = dbp_tr, $
	DEF_TR	   = def_tr, $
	SOA		   = soa, $
...
FOR i = 0, nfile -1 DO BEGIN	
	...
	NCDF_ATTPUT, oid, 'REFL', 'units',     'dBZ'																;Units attribute
   	...
   	IF scheme EQ 'morrison' THEN BEGIN 															;Don't do cloud number conc. for morrison (not outputted)
...
;   NCDF_ATTPUT, oid, 'HCL', 'units', 'ppmv'                                                       ;Units attribute  
	...
	IF KEYWORD_SET(soa) THEN BEGIN
    	vid = NCDF_VARDEF(oid, 'ASOA1J', [xid, yid, zid], /FLOAT)                                         ;Define the HO2 attribute
    	NCDF_ATTPUT, oid, 'ASOA1J', 'long_name', 'SOA Anth. org. conc. with  C* value=1 ug/m3 Acc. mode'                                       ;Name attribute
    	NCDF_ATTPUT, oid, 'ASOA1J', 'units', 'ug/kg-dryair'                                                       ;Units attribute  
	
    	vid = NCDF_VARDEF(oid, 'ASOA1I', [xid, yid, zid], /FLOAT)                                         ;Define the HO2 attribute
    	NCDF_ATTPUT, oid, 'ASOA1I', 'long_name', 'SOA Anth. org. conc. with  C* value=1 ug/m3 Aitken mode'                                       ;Name attribute
    	NCDF_ATTPUT, oid, 'ASOA1I', 'units', 'ug/kg-dryair'                                                       ;Units attribute  

    	vid = NCDF_VARDEF(oid, 'ASOA2J', [xid, yid, zid], /FLOAT)                                         ;Define the HO2 attribute
    	NCDF_ATTPUT, oid, 'ASOA2J', 'long_name', 'SOA Anth. org. conc. with  C* value=10 ug/m3 Acc. mode'                                       ;Name attribute
    	NCDF_ATTPUT, oid, 'ASOA2J', 'units', 'ug/kg-dryair'                                                       ;Units attribute  

    	vid = NCDF_VARDEF(oid, 'ASOA2I', [xid, yid, zid], /FLOAT)                                         ;Define the HO2 attribute
    	NCDF_ATTPUT, oid, 'ASOA2I', 'long_name', 'SOA Anth. org. conc. with  C* value=10 ug/m3 Aitken mode'                                       ;Name attribute
    	NCDF_ATTPUT, oid, 'ASOA2I', 'units', 'ug/kg-dryair'                                                       ;Units attribute  

    	vid = NCDF_VARDEF(oid, 'ASOA3J', [xid, yid, zid], /FLOAT)                                         ;Define the HO2 attribute
    	NCDF_ATTPUT, oid, 'ASOA3J', 'long_name', 'SOA Anth. org. conc. with  C* value=100 ug/m3 Acc. mode'                                       ;Name attribute
    	NCDF_ATTPUT, oid, 'ASOA3J', 'units', 'ug/kg-dryair'                                                       ;Units attribute  

    	vid = NCDF_VARDEF(oid, 'ASOA3I', [xid, yid, zid], /FLOAT)                                         ;Define the HO2 attribute
    	NCDF_ATTPUT, oid, 'ASOA3I', 'long_name', 'SOA Anth. org. conc. with  C* value=100 ug/m3 Aitken. mode'                                       ;Name attribute
    	NCDF_ATTPUT, oid, 'ASOA3I', 'units', 'ug/kg-dryair'                                                       ;Units attribute  

    	vid = NCDF_VARDEF(oid, 'ASOA4J', [xid, yid, zid], /FLOAT)                                         ;Define the HO2 attribute
    	NCDF_ATTPUT, oid, 'ASOA4J', 'long_name', 'SOA Anth. org. conc. with  C* value=1000 ug/m3 Acc. mode'                                       ;Name attribute
    	NCDF_ATTPUT, oid, 'ASOA4J', 'units', 'ug/kg-dryair'                                                       ;Units attribute  

    	vid = NCDF_VARDEF(oid, 'ASOA4I', [xid, yid, zid], /FLOAT)                                         ;Define the HO2 attribute
    	NCDF_ATTPUT, oid, 'ASOA4I', 'long_name', 'SOA Anth. org. conc. with  C* value=1000 ug/m3 Aitken mode'                                       ;Name attribute
    	NCDF_ATTPUT, oid, 'ASOA4I', 'units', 'ug/kg-dryair'                                                       ;Units attribute  

    	vid = NCDF_VARDEF(oid, 'BSOA1J', [xid, yid, zid], /FLOAT)                                         ;Define the HO2 attribute
    	NCDF_ATTPUT, oid, 'BSOA1J', 'long_name', 'SOA Biog. org. conc. with  C* value=1 ug/m3 Acc. mode'                                       ;Name attribute
    	NCDF_ATTPUT, oid, 'BSOA1J', 'units', 'ug/kg-dryair'                                                       ;Units attribute  
	
    	vid = NCDF_VARDEF(oid, 'BSOA1I', [xid, yid, zid], /FLOAT)                                         ;Define the HO2 attribute
    	NCDF_ATTPUT, oid, 'BSOA1I', 'long_name', 'SOA Biog. org. conc. with  C* value=1 ug/m3 Aitken mode'                                       ;Name attribute
    	NCDF_ATTPUT, oid, 'BSOA1I', 'units', 'ug/kg-dryair'                                                       ;Units attribute  

    	vid = NCDF_VARDEF(oid, 'BSOA2J', [xid, yid, zid], /FLOAT)                                         ;Define the HO2 attribute
    	NCDF_ATTPUT, oid, 'BSOA2J', 'long_name', 'SOA Biog. org. conc. with  C* value=10 ug/m3 Acc. mode'                                       ;Name attribute
    	NCDF_ATTPUT, oid, 'BSOA2J', 'units', 'ug/kg-dryair'                                                       ;Units attribute  

    	vid = NCDF_VARDEF(oid, 'BSOA2I', [xid, yid, zid], /FLOAT)                                         ;Define the HO2 attribute
    	NCDF_ATTPUT, oid, 'BSOA2I', 'long_name', 'SOA Biog. org. conc. with  C* value=10 ug/m3 Aitken mode'                                       ;Name attribute
    	NCDF_ATTPUT, oid, 'BSOA2I', 'units', 'ug/kg-dryair'                                                       ;Units attribute  

    	vid = NCDF_VARDEF(oid, 'BSOA3J', [xid, yid, zid], /FLOAT)                                         ;Define the HO2 attribute
    	NCDF_ATTPUT, oid, 'BSOA3J', 'long_name', 'SOA Biog. org. conc. with  C* value=100 ug/m3 Acc. mode'                                       ;Name attribute
    	NCDF_ATTPUT, oid, 'BSOA3J', 'units', 'ug/kg-dryair'                                                       ;Units attribute  

    	vid = NCDF_VARDEF(oid, 'BSOA3I', [xid, yid, zid], /FLOAT)                                         ;Define the HO2 attribute
    	NCDF_ATTPUT, oid, 'BSOA3I', 'long_name', 'SOA Biog. org. conc. with  C* value=100 ug/m3 Aitken. mode'                                       ;Name attribute
    	NCDF_ATTPUT, oid, 'BSOA3I', 'units', 'ug/kg-dryair'                                                       ;Units attribute  

    	vid = NCDF_VARDEF(oid, 'BSOA4J', [xid, yid, zid], /FLOAT)                                         ;Define the HO2 attribute
    	NCDF_ATTPUT, oid, 'BSOA4J', 'long_name', 'SOA Biog. org. conc. with  C* value=1000 ug/m3 Acc. mode'                                       ;Name attribute
    	NCDF_ATTPUT, oid, 'BSOA4J', 'units', 'ug/kg-dryair'                                                       ;Units attribute  

    	vid = NCDF_VARDEF(oid, 'BSOA4I', [xid, yid, zid], /FLOAT)                                         ;Define the HO2 attribute
    	NCDF_ATTPUT, oid, 'BSOA4I', 'long_name', 'SOA Biog. org. conc. with  C* value=1000 ug/m3 Aitken mode'                                       ;Name attribute
    	NCDF_ATTPUT, oid, 'BSOA4I', 'units', 'ug/kg-dryair'                                                       ;Units attribute  
	ENDIF
	...
	IF KEYWORD_SET(dbp_tr) THEN BEGIN
		...
		vid = NCDF_VARDEF(oid, 'Passive_TR_tracer', [xid, yid, zid], /FLOAT)									;Define the upper troposphere tracer variable
		NCDF_ATTPUT, oid, 'Passive_TR_tracer', 'long_name', 'Passive TR Tracer'									;Name attribute
		NCDF_ATTPUT, oid, 'Passive_TR_tracer', 'units',     'Passive TR = 1, 0 otherwise'				;Units attribute

		vid = NCDF_VARDEF(oid, 'Passive_Overworld_ST_tracer', [xid, yid, zid], /FLOAT)									;Define the upper troposphere tracer variable
		NCDF_ATTPUT, oid, 'Passive_Overworld_ST_tracer', 'long_name', 'Passive Overworld ST Tracer'									;Name attribute
		NCDF_ATTPUT, oid, 'Passive_Overworld_ST_tracer', 'units',     'Passive Overworld ST = 1, 0 otherwise'				;Units attribute
	...
	IF KEYWORD_SET(def_tr) THEN BEGIN
		vid = NCDF_VARDEF(oid, 'TR_tracer', [xid, yid, zid], /FLOAT)									;Define the tropospheric tracer variable
		NCDF_ATTPUT, oid, 'TR_tracer', 'long_name', 'Not sure what this actually is'								;Name attribute
		NCDF_ATTPUT, oid, 'TR_tracer', 'units',     'Troposphere = 1, 0 otherwise'					;Units attribute

		vid = NCDF_VARDEF(oid, 'Decay_tracer', [xid, yid, zid], /FLOAT)									;Define the tropospheric boundary layer tracer variable
		NCDF_ATTPUT, oid, 'Decay_tracer', 'long_name', 'Decaying Tracer'			;Name attribute
		NCDF_ATTPUT, oid, 'Decay_tracer', 'units',     'Boundary Layer = 1, 0 otherwise'				;Units attribute

		vid = NCDF_VARDEF(oid, 'ATM_tracer', [xid, yid, zid], /FLOAT)									;Define the middle troposphere tracer variable
		NCDF_ATTPUT, oid, 'ATM_tracer', 'long_name', 'Whole Atmosphere Tracer'						;Name attribute
		NCDF_ATTPUT, oid, 'ATM_tracer', 'units',     'Reset every time and grid point'					;Units attribute

		vid = NCDF_VARDEF(oid, 'ATM_Decay_tracer', [xid, yid, zid], /FLOAT)									;Define the middle troposphere tracer variable
		NCDF_ATTPUT, oid, 'ATM_Decay_tracer', 'long_name', 'Whole Atmosphere Decay Tracer'						;Name attribute
		NCDF_ATTPUT, oid, 'ATM_Decay_tracer', 'units',     'Reset every time and grid point, but decaying'					;Units attribute

		vid = NCDF_VARDEF(oid, 'ST_tracer', [xid, yid, zid], /FLOAT)									;Define the Stratospheric tracer variable
		NCDF_ATTPUT, oid, 'ST_tracer', 'long_name', 'Stratospheric Tracer'							;Name attribute
		NCDF_ATTPUT, oid, 'ST_tracer', 'units',     'Stratosphere = 1, 0 otherwise'				;Units attribute

		vid = NCDF_VARDEF(oid, 'ST_Decay_tracer', [xid, yid, zid], /FLOAT)									;Define the Stratospheric tracer variable
		NCDF_ATTPUT, oid, 'ST_Decay_tracer', 'long_name', 'Stratospheric Decay Tracer'							;Name attribute
		NCDF_ATTPUT, oid, 'ST_Decay_tracer', 'units',     'Stratosphere = 1, 0 otherwise'				;Units attribute

		vid = NCDF_VARDEF(oid, 'BL_tracer', [xid, yid, zid], /FLOAT)									;Define the tropospheric boundary layer tracer variable
		NCDF_ATTPUT, oid, 'BL_tracer', 'long_name', 'Tropospheric Boundary Layer Tracer'			;Name attribute
		NCDF_ATTPUT, oid, 'BL_tracer', 'units',     'Boundary Layer = 1, 0 otherwise'				;Units attribute

		vid = NCDF_VARDEF(oid, 'BL_Decay_tracer', [xid, yid, zid], /FLOAT)									;Define the tropospheric boundary layer tracer variable
		NCDF_ATTPUT, oid, 'BL_Decay_tracer', 'long_name', 'Tropospheric Boundary Layer Decay Tracer'			;Name attribute
		NCDF_ATTPUT, oid, 'BL_Decay_tracer', 'units',     'Boundary Layer = 1, 0 otherwise'				;Units attribute
	ENDIF
...
PRINT, 'working...'
	...
	IF KEYWORD_SET(dbp_tr) THEN BEGIN
		...
		NCDF_VARPUT, oid, 'Passive_TR_tracer', values

		NCDF_VARGET, iid, 'tr17_8',		values
		NCDF_VARPUT, oid, 'Passive_Overworld_ST_tracer', values
	ENDIF
	...
	IF KEYWORD_SET(def_tr) THEN BEGIN
		...
		NCDF_VARGET, iid, 'tr17_2',    values																	;Read tracer
		NCDF_VARPUT, oid, 'Decay_tracer', values																	;Write tracer
	
		NCDF_VARGET, iid, 'tr17_3',    values																	;Read tracer
		NCDF_VARPUT, oid, 'ATM_tracer', values																	;Write tracer
	
		NCDF_VARGET, iid, 'tr17_4',    values																	;Read tracer
		NCDF_VARPUT, oid, 'ATM_Decay_tracer', values																	;Write tracer
	
		NCDF_VARGET, iid, 'tr17_5',    values																	;Read tracer
		NCDF_VARPUT, oid, 'ST_tracer', values																	;Write tracer
	
		NCDF_VARGET, iid, 'tr17_6',    values																	;Read tracer
		NCDF_VARPUT, oid, 'ST_Decay_tracer', values																	;Write tracer
	
		NCDF_VARGET, iid, 'tr17_7',    values																	;Read tracer
		NCDF_VARPUT, oid, 'BL_tracer', values																	;Write tracer

		NCDF_VARGET, iid, 'tr17_8',    values																	;Read tracer
		NCDF_VARPUT, oid, 'BL_Decay_tracer', values																	;Write tracer
	ENDIF
...
;	NCDF_VARPUT, oid, 'HCL', values																				;Write HCL
	...
	IF (KEYWORD_SET(soa)) THEN BEGIN
		NCDF_VARGET, iid, 'asoa1j', values
		NCDF_VARPUT, oid, 'ASOA1J', values

		NCDF_VARGET, iid, 'asoa1i', values
		NCDF_VARPUT, oid, 'ASOA1I', values

		NCDF_VARGET, iid, 'asoa2j', values
		NCDF_VARPUT, oid, 'ASOA2J', values

		NCDF_VARGET, iid, 'asoa2i', values
		NCDF_VARPUT, oid, 'ASOA2I', values

		NCDF_VARGET, iid, 'asoa3j', values
		NCDF_VARPUT, oid, 'ASOA3J', values

		NCDF_VARGET, iid, 'asoa3i', values
		NCDF_VARPUT, oid, 'ASOA3I', values

		NCDF_VARGET, iid, 'asoa4j', values
		NCDF_VARPUT, oid, 'ASOA4J', values

		NCDF_VARGET, iid, 'asoa4i', values
		NCDF_VARPUT, oid, 'ASOA4I', values

		NCDF_VARGET, iid, 'bsoa1j', values
		NCDF_VARPUT, oid, 'BSOA1J', values

		NCDF_VARGET, iid, 'bsoa1i', values
		NCDF_VARPUT, oid, 'BSOA1I', values

		NCDF_VARGET, iid, 'bsoa2j', values
		NCDF_VARPUT, oid, 'BSOA2J', values

		NCDF_VARGET, iid, 'bsoa2i', values
		NCDF_VARPUT, oid, 'BSOA2I', values

		NCDF_VARGET, iid, 'bsoa3j', values
		NCDF_VARPUT, oid, 'BSOA3J', values

		NCDF_VARGET, iid, 'bsoa3i', values
		NCDF_VARPUT, oid, 'BSOA3I', values

		NCDF_VARGET, iid, 'bsoa4j', values
		NCDF_VARPUT, oid, 'BSOA4J', values

		NCDF_VARGET, iid, 'bsoa4i', values
		NCDF_VARPUT, oid, 'BSOA4I', values
	ENDIF
