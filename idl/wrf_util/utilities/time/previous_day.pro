...
;		PREVIOUS_DAY
;PURPOSE:
;		This functions returns the date of the day preceding the input date.
;CATEGORY:
;		Date and time calculations.
;CALLING SEQUENCE:
;		next = PREVIOUS_DAY(date)
;INPUT:
;		date  : CDATE or JTIME structure
;OUTPUT:
;     CDATE structure containing the date of the day preceding the input date
