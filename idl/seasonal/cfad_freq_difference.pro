...
FOR i = 0,1 DO BEGIN
        ...
        FOREACH date, date_arr DO BEGIN
        	PRINT, date
        	    ...
        	    IF (good_count GT 0) THEN BEGIN
    				...
    				IF (var EQ 'H2O') THEN PRINT, MAX(var1[*,*,50:*],/NAN)*factor
    				var_arr	    = var1[good]
 ...
 ;               table  = GRAY_LOGSCALE_24(20, 0.75, 0.0, PS = ps)													;Color table for plotting 
  				table  = GRAY_LOGSCALE_24(20, 0.85, 0.0, PS = ps)	
...
;Will have to manually edit xranges in adobe illustrator    
IF KEYWORD_SET(difference) THEN BEGIN 
	FOREACH var, var_set DO BEGIN
		CASE var OF 
			'H2O': BEGIN
