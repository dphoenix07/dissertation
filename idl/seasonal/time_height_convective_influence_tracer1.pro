PRO TIME_HEIGHT_CONVECTIVE_INFLUENCE_TRACER1, event, start_date, end_date, $
	DOMAIN         = domain, $
...
;+
; Name:
;		TIME_HEIGHT_CONVECTIVE_INFLUENCE_TRACER1
; Purpose:
...
;		areas.
; Calling sequence:
;		TIME_HEIGHT_CONVECTIVE_INFLUENCE_TRACER1, run, start_date, end_date
; Example: TIME_HEIGHT_CONVECTIVE_INFLUENCE_TRACER1,'20110518','20110518T1300Z','20110527T1200Z', tracer = 'O3'
; Input:
...
;
;								2018-05-31. Script to compute and write variables needed 
;											for time-height sections.
;-
...
FOREACH date, date_arr DO BEGIN
    ...
    tracerT	  = plt_var_T      
    tracerpot = plt_var_thet    
    tracero3  = plt_var_o3     * factor1
    tracerh2o = plt_var_h2o    * factor2 
...
IF ((N_ELEMENTS(tracerpot_nc) GT 0)) THEN BEGIN
...
;Fill arrays with data points where there is convection
