...
;input wrfinput file 
domain = 'd01'
wrfinput_file  = '/data3/dphoenix/wrf/wrfchemi/20130805/wrfinput_'+domain
;input emission data directory

area_emis_dir   = '/data3/dphoenix/wrf/wrfchemi/20130805/'
point_emis_dir  = '/data3/dphoenix/wrf/wrfchemi/20130805/'
ipoint = 224097L 
...
output_dir = '/data3/dphoenix/wrf/wrfchemi/20130805/'
...
; Aromatic kOH > 20000 /ppm/min exclude(xylenes), Xylenes
	tmp = 
	ncdf_varput,ncid,'E_XYL',reform(wrfemis[14,*,*,*]+wrfemis[37,*,*,*])
