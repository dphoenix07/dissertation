PRO PLOT_TRACER_RALT, tracer_gv, tracer_dc8, ralt, gv_values, dc8_values, $
	TITLE    = title, $
	XTITLE   = xtitle, $
	XRANGE   = xrange, $
	XLOG     = xlog, $
...
; Calling sequence:
;		PLOT_TRACER_RALT, tracer, ralt
; Input:
;		tracer : Array of trace gas measurements.
;		ralt   : Array of relative altitude points.
;		cloud  : Array of cloud particle measurements.
;
; Output:
;		Trace gas measurements at relative altitude. 
; Keywords:
...
;		Daniel B. Phoenix	2016-01-26.	Added section to sort measurements by in cloud 
;										and out of cloud.
;-
...
IF (N_ELEMENTS(ytitle) EQ 0) THEN ytitle = 'Relative Altitude (km)'
...
table = WHITE_RED_24(40, 0.35, 1.0);, PS = ps)														;Color table for plotting 
